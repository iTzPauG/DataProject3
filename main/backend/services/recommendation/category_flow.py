...
FLOW_DEFINITIONS: dict[str, dict] = {
    ...
    "education": {
        ...
        "fallback_radius_m": 5000,
        "max_radius_m": 15000,
        "provider_types": ["library", "university", "school"],
        "mood_title": "¿Qué necesitas?",
        "mood_subtitle": "Elige tu prioridad",
        "subcategories": [
            {"id": "library", "label": "Biblioteca", "emoji": "📚"},
            {"id": "tutoring", "label": "Clases particulares", "emoji": "🙋"},
        ...
        "moods": [
            ...
            {"id": "affordable", "label": "Precio asequible", "emoji": "💰"},
            {"id": "flexible_hours", "label": "Horario flexible", "emoji": "🕑"},
        ],
    },
    "cinema": {
        "label": "Cine",
